...
var (
	...
	createCveIssue = &cobra.Command{
		...
		PostRunE: func(cmd *cobra.Command, args []string) error {
			if backportFlag {
				if err := backportIssueCmd.RunE(cmd, args); err != nil {
...
func init() {
	...
	createCveIssue.Flags().BoolVarP(&backportFlag, "backport", "b", true, "Create backport issue to all or specified EOL Supported Golang Version(s). All versions by default")
