...
import (
	...
	"github.com/aws/eks-distro-build-tooling/tools/eksDistroBuildToolingOpsTools/pkg/git/mocks"
)
...
func TestGoGitAdd(t *testing.T) {
	...
	client.EXPECT().OpenRepo().Return(&goGit.Repository{}, nil)
...
func TestGoGitBranch(t *testing.T) {
	...
	client.EXPECT().OpenRepo().Return(repo, nil)
...
func newGoGitMock(t *testing.T) (context.Context, *mocks.MockGoGit) {
	ctx := context.Background()
	ctrl := gomock.NewController(t)
	client := mocks.NewMockGoGit(ctrl)
