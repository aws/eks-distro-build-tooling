...
if [[ $JOB_NAME =~ $GOLANG_RELEASE_PERIODIC ]]; then
  ...
  cp -rfv ${SCRIPT_ROOT}/../builder-base/checksums ./builder-base/checksums
  cp -rfv ${SCRIPT_ROOT}/../eks-distro-base/make-tests/expected ./eks-distro-base/make-tests/expected/
  git add ./EKS_DISTRO_TAG_FILE.yaml
