...
GITHUB_TOKEN=$(aws secretsmanager get-secret-value  --secret-id github-eks-distro-pr-bot --query SecretString | jq -r | jq ."github-token" | jq -r)
...
git remote add origin https://github.com/eks-distro-pr-bot/${REPO}.git
git fetch upstream
