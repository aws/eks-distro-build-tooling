...
minimal-images-base-python-compiler-3.9-base: ## Build, export packages, validate and run tests for minimal variant `base-python-compiler-3.9-base`
minimal-images-base-python-compiler-3.9-yum: ## Build, export packages, validate and run tests for minimal variant `base-python-compiler-3.9-yum`
minimal-images-base-python-compiler-3.9-gcc: ## Build, export packages, validate and run tests for minimal variant `base-python-compiler-3.9-gcc`
...
minimal-images-base-golang-compiler-1.13-base: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.13-base`
minimal-images-base-golang-compiler-1.14-base: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.14-base`
...
minimal-images-base-golang-compiler-1.13-yum: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.13-yum`
minimal-images-base-golang-compiler-1.14-yum: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.14-yum`
...
minimal-images-base-golang-compiler-1.13-gcc: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.13-gcc`
minimal-images-base-golang-compiler-1.14-gcc: ## Build, export packages, validate and run tests for minimal variant `base-golang-compiler-1.14-gcc`
...
packages-export-minimal-images-base-python-compiler-3.9-base: ## Export packages for minimal variant `base-python-compiler-3.9-base`
packages-export-minimal-images-base-python-compiler-3.9-yum: ## Export packages for minimal variant `base-python-compiler-3.9-yum`
packages-export-minimal-images-base-python-compiler-3.9-gcc: ## Export packages for minimal variant `base-python-compiler-3.9-gcc`
...
packages-export-minimal-images-base-golang-compiler-1.13-base: ## Export packages for minimal variant `base-golang-compiler-1.13-base`
packages-export-minimal-images-base-golang-compiler-1.14-base: ## Export packages for minimal variant `base-golang-compiler-1.14-base`
...
packages-export-minimal-images-base-golang-compiler-1.13-yum: ## Export packages for minimal variant `base-golang-compiler-1.13-yum`
packages-export-minimal-images-base-golang-compiler-1.14-yum: ## Export packages for minimal variant `base-golang-compiler-1.14-yum`
...
packages-export-minimal-images-base-golang-compiler-1.13-gcc: ## Export packages for minimal variant `base-golang-compiler-1.13-gcc`
packages-export-minimal-images-base-golang-compiler-1.14-gcc: ## Export packages for minimal variant `base-golang-compiler-1.14-gcc`
...
validate-minimal-images-base-python-compiler-3.9-base: ## Validate for minimal variant `base-python-compiler-3.9-base`
validate-minimal-images-base-python-compiler-3.9-yum: ## Validate for minimal variant `base-python-compiler-3.9-yum`
validate-minimal-images-base-python-compiler-3.9-gcc: ## Validate for minimal variant `base-python-compiler-3.9-gcc`
...
validate-minimal-images-base-golang-compiler-1.13-base: ## Validate for minimal variant `base-golang-compiler-1.13-base`
validate-minimal-images-base-golang-compiler-1.14-base: ## Validate for minimal variant `base-golang-compiler-1.14-base`
...
validate-minimal-images-base-golang-compiler-1.13-yum: ## Validate for minimal variant `base-golang-compiler-1.13-yum`
validate-minimal-images-base-golang-compiler-1.14-yum: ## Validate for minimal variant `base-golang-compiler-1.14-yum`
...
validate-minimal-images-base-golang-compiler-1.13-gcc: ## Validate for minimal variant `base-golang-compiler-1.13-gcc`
validate-minimal-images-base-golang-compiler-1.14-gcc: ## Validate for minimal variant `base-golang-compiler-1.14-gcc`
...
test-minimal-images-base-python-compiler-3.9-base: ## Run tests for minimal variant `base-python-compiler-3.9-base`
test-minimal-images-base-python-compiler-3.9-yum: ## Run tests for minimal variant `base-python-compiler-3.9-yum`
test-minimal-images-base-python-compiler-3.9-gcc: ## Run tests for minimal variant `base-python-compiler-3.9-gcc`
...
test-minimal-images-base-golang-compiler-1.13-base: ## Run tests for minimal variant `base-golang-compiler-1.13-base`
test-minimal-images-base-golang-compiler-1.14-base: ## Run tests for minimal variant `base-golang-compiler-1.14-base`
...
test-minimal-images-base-golang-compiler-1.13-yum: ## Run tests for minimal variant `base-golang-compiler-1.13-yum`
test-minimal-images-base-golang-compiler-1.14-yum: ## Run tests for minimal variant `base-golang-compiler-1.14-yum`
...
test-minimal-images-base-golang-compiler-1.13-gcc: ## Run tests for minimal variant `base-golang-compiler-1.13-gcc`
test-minimal-images-base-golang-compiler-1.14-gcc: ## Run tests for minimal variant `base-golang-compiler-1.14-gcc`
...
minimal-update-base-python-compiler-3.9-base: ## Run update logic for minimal variant `base-python-compiler-3.9-base`
minimal-update-base-python-compiler-3.9-yum: ## Run update logic for minimal variant `base-python-compiler-3.9-yum`
minimal-update-base-python-compiler-3.9-gcc: ## Run update logic for minimal variant `base-python-compiler-3.9-gcc`
...
minimal-update-base-golang-compiler-1.13-base: ## Run update logic for minimal variant `base-golang-compiler-1.13-base`
minimal-update-base-golang-compiler-1.14-base: ## Run update logic for minimal variant `base-golang-compiler-1.14-base`
...
minimal-update-base-golang-compiler-1.13-yum: ## Run update logic for minimal variant `base-golang-compiler-1.13-yum`
minimal-update-base-golang-compiler-1.14-yum: ## Run update logic for minimal variant `base-golang-compiler-1.14-yum`
...
minimal-update-base-golang-compiler-1.13-gcc: ## Run update logic for minimal variant `base-golang-compiler-1.13-gcc`
minimal-update-base-golang-compiler-1.14-gcc: ## Run update logic for minimal variant `base-golang-compiler-1.14-gcc`
...
minimal-create-pr-base-python-compiler-3.9-base: ## Run create pr logic for minimal variant `base-python-compiler-3.9-base`
minimal-create-pr-base-python-compiler-3.9-yum: ## Run create pr logic for minimal variant `base-python-compiler-3.9-yum`
minimal-create-pr-base-python-compiler-3.9-gcc: ## Run create pr logic for minimal variant `base-python-compiler-3.9-gcc`
...
minimal-create-pr-base-golang-compiler-1.13-base: ## Run create pr logic for minimal variant `base-golang-compiler-1.13-base`
minimal-create-pr-base-golang-compiler-1.14-base: ## Run create pr logic for minimal variant `base-golang-compiler-1.14-base`
...
minimal-create-pr-base-golang-compiler-1.13-yum: ## Run create pr logic for minimal variant `base-golang-compiler-1.13-yum`
minimal-create-pr-base-golang-compiler-1.14-yum: ## Run create pr logic for minimal variant `base-golang-compiler-1.14-yum`
...
minimal-create-pr-base-golang-compiler-1.13-gcc: ## Run create pr logic for minimal variant `base-golang-compiler-1.13-gcc`
minimal-create-pr-base-golang-compiler-1.14-gcc: ## Run create pr logic for minimal variant `base-golang-compiler-1.14-gcc`
